...
declare global {
  ...
  const FlappyBird: typeof import('./components/apps/FlappyBird')['default']
  ...
  const MusicPlayer: typeof import('./components/apps/MusicPlayer')['default']
  const Notes: typeof import('./components/apps/Notes')['default']
  const Paint: typeof import('./components/apps/Paint')['default']
